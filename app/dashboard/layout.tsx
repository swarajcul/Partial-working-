...
export default function DashboardLayout({
  ...
  // useEffect for pushing to /auth/login is already above and uses the first router instance.
  // The second useEffect block for router.push("/auth/login") was redundant after merging.
  // The primary logic for redirecting if !loading && !user is handled by the first useEffect.
